---
title: 'MCP and databases, and it's virality'
publishedAt: '2025-01-13'
summary: 'MCP and databases, and it's virality'
---
...
- Navigated to env_data_y_calc table
...
After saving the configuration, we restarted Claude Desktop. That's it. Claude could now directly interact with our Supabase database. Here's simple video to explore and build picture:

<iframe width="860" height="415" src="https://drive.google.com/file/d/118Zvy5_jdXBC_CtNylCiXJLGJ2K9hPn5/view?usp=sharing" title="Video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
